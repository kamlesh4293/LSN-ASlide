...
//            position = position+1
        ...
        private fun addViewBeing(ctx: Context, list: List<News>) {
            if(list.size > being_position) {
                ...
                textview.textSize = WidgetNewsList.setting_obj?.titleSize!!.toFloat()
                desc_textview.textSize = WidgetNewsList.setting_obj?.descSize!!.toFloat()
