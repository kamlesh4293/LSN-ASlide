...
public class USBSerialConnector implements SerialInputOutputManager.Listener {
    ...
    public void pausedActivity() {
        ...
        if (serialPort != null) {
            try {
                ...
                usbSerialListener.onErrorReceived(UsbUtilities.getStackTrace(e));
            }
            serialPort = null;
        }
    }
    ...
    public void onNewData(final byte[] data) {
        ...
        Log.d(TAG, UsbUtilities.bytesToString(data));
    ...
    public void onRunError(Exception e) {
        //removeTimeOutCallbacks();
        usbSerialListener.onErrorReceived("onRunError: " + UsbUtilities.getStackTrace(e));
    }
            ...
            try {
                ...
                if (connection == null) {
                    ...
                    try {
                        ...
                        Log.d(TAG, "Error setting up device: " + UsbUtilities.getStackTrace(e));
                        pausedActivity();
                        serialPort = null;
                    }
                }
